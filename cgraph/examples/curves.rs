...
fn main() {
    ...
    win.add_object(create_cubic_bezier(
        Position::new(350.0, 500.0),    // start
        Position::new(400.0, 200.0),    // control1
        Position::new(500.0, 200.0),    // control2
        Position::new(550.0, 500.0),    // end
    ...
    win.add_object(create_arc(
        Position::new(400.0, 300.0),    // center
        80.0,                           // radius
        0.0,                            // start_angle
        std::f32::consts::PI,           // end_angle (half circle)
